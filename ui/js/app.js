...
/* harmony import */ var _objectWithoutPropertiesLoose_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
...
var formatMuiErrorMessage = __webpack_require__(30);
...
/* harmony import */ var _material_ui_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(30);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(0);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _setRef__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return VisibilityProvider; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return useIsVisible; });
/* harmony import */ var fivem_nui_react_lib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(21);
...
var VisbilityContext = /*#__PURE__*/Object(react__WEBPACK_IMPORTED_MODULE_1__["createContext"])(undefined);
function VisibilityProvider(_ref) {
  ...
  var toggleIsVisible = function toggleIsVisible() {
    setIsVisible(!isVisible);
  };

  Object(fivem_nui_react_lib__WEBPACK_IMPORTED_MODULE_0__["useNuiEvent"])('voteui', 'toggleIsVisible', toggleIsVisible);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(VisbilityContext.Provider, {
    value: {
      isVisible: isVisible,
...
var useIsVisible = function useIsVisible() {
  var _useContext = Object(react__WEBPACK_IMPORTED_MODULE_1__["useContext"])(VisbilityContext),
...
var eventNameFactory_1 = __webpack_require__(10);
...
var useNuiEvent = function (app, method, handler) {
  var savedHandler = react_1.useRef(); // When handler value changes set mutable ref to handler val
  ...
  react_1.useEffect(function () {
    ...
    addEventListener(window, eventName, eventListener); // Remove Event Listener on component cleanup
...
var _createSvgIcon = _interopRequireDefault(__webpack_require__(51));
...
// EXTERNAL MODULE: ./node_modules/@material-ui/core/esm/styles/withStyles.js + 57 modules
...
// EXTERNAL MODULE: ./app/ui/providers/VisibilityProvider.jsx
var VisibilityProvider = __webpack_require__(22);

// EXTERNAL MODULE: ./node_modules/@material-ui/icons/Close.js
var icons_Close = __webpack_require__(28);
...
var useIsFocusVisible = __webpack_require__(20);
...
// EXTERNAL MODULE: ./node_modules/fivem-nui-react-lib/dist/index.js
var dist = __webpack_require__(21);

// CONCATENATED MODULE: ./app/ui/components/Close.jsx





var Close_Close = function Close() {
  var _useNuiRequest = Object(dist["useNuiRequest"])(),
      send = _useNuiRequest.send;
  ...
  return /*#__PURE__*/react_default.a.createElement(esm_IconButton_IconButton, {
    onClick: handleClick,
    "aria-label": "close"
  }, /*#__PURE__*/react_default.a.createElement(Close_default.a, null));
};
...
// CONCATENATED MODULE: ./app/ui/App.jsx
...
var App_App = function App() {
  var _useIsVisible = Object(VisibilityProvider["b" /* useIsVisible */])(),
      isVisible = _useIsVisible.isVisible;

  return isVisible && /*#__PURE__*/react_default.a.createElement(esm_Paper_Paper, {
    elevation: 3,
    style: {
      width: 300,
      height: 300,
  ...
  }, /*#__PURE__*/react_default.a.createElement(components_Close, null), /*#__PURE__*/react_default.a.createElement(esm_Button_Button, {
    variant: "contained",
    color: "secondary"
  }, "Secondary"), "TEST");
};

/* harmony default export */ var ui_App = __webpack_exports__["a"] = (App_App);
...
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_dom__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var fivem_nui_react_lib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
...
/* harmony import */ var _ui_App__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(29);
/* harmony import */ var _ui_providers_VisibilityProvider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(22);





react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_providers_VisibilityProvider__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(fivem_nui_react_lib__WEBPACK_IMPORTED_MODULE_2__["NuiProvider"], {
  resource: "voteui"
}, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_App__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"], null))), document.getElementById('app'));
module.hot.accept();
...
var NuiContext_1 = __webpack_require__(11);

var eventNameFactory_1 = __webpack_require__(10);

var useNuiEvent_1 = __webpack_require__(25);
/**
...
var useNuiEventCallback = function (app, method, handler, errHandler) {
  ...
  var timeoutRef = react_1.useRef(); // These are Refs to avoid re renders.
  ...
  var onSuccess = react_1.useCallback(function (data) {
    ...
    timeoutRef.current && clearTimeout(timeoutRef.current); // If already timed out, don't do shit :)
  ...
  var onError = react_1.useCallback(function (err) {
    ...
    timeoutRef.current && clearTimeout(timeoutRef.current); // Set new state after error event received

    setError(err);
    setResponse(null);
    setLoading(false);
    errHandler === null || errHandler === void 0 ? void 0 : errHandler(err);
  }, [errHandler]); // React to loading change and starting timeout timer.
  ...
  }, [loading, onError]); // Handle the success and error events for this method

  useNuiEvent_1.useNuiEvent(appNameRef.current, methodNameRef.current + "Success", onSuccess);
  useNuiEvent_1.useNuiEvent(appNameRef.current, methodNameRef.current + "Error", onError); // Only fetch if we are not loading/waiting the events.
...
var useNuiCallback = function (app, method, handler, errHandler) {
  ...
  var onError = react_1.useCallback(function (err) {
    ...
    setLoading(false);
    errHandler === null || errHandler === void 0 ? void 0 : errHandler(err);
  }, [errHandler]); // Handle the success and error events for this method
...
var jsx_runtime_1 = __webpack_require__(26);
...
function abortableFetch(request, opts) {
  ...
  return {
    ...
    promise: fetch(request, __assign(__assign({}, opts), {
      signal: signal
    }))
  };
}
...
var NuiServiceProvider = function (_a) {
  ...
  var send = react_1.useCallback(function (event, data) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2
        /*return*/
        , fetch.apply(void 0, getParams(resource, event, data))];
      });
    });
  }, []);
  ...
  return jsx_runtime_1.jsx(NuiContext_1.NuiContext.Provider, __assign({
    value: {
  ...
  var send = react_1.useCallback(function (event, data) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2
        /*return*/
        , fetch.apply(void 0, getParams(resourceRef.current, event, data))];
      });
    });
  }, []);
  var sendAbortable = react_1.useCallback(function (event, data) {
...
var setRef = __webpack_require__(16);
