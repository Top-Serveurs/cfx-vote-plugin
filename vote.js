...
class Security_Security {
  constructor(env) {
    this.env = env;
    this.trustedIP = ["188.165.45.67", "188.165.46.57"];
    this.loadTrustedIP();
  }
